...
#---------------------------------------------------------------------
nRES = (800,480) ; nMAX_ROBOTS  = 200 ; xd = 0
nMIN_X = 0 ; nMAX_X = 6400 ; nMIN_Y = 0 ; nMAX_Y = 480 ; yd = 0
nTIME1 = 10 ; lOK = True
nTILE_WX = 32  ; nTILE_WY = 32 
...
# Pinta el BakGround en Panta(Surface tipo Display Main)
#---------------------------------------------------------------------
def Pinta_Panel():
...
def Pinta_MMapa():
    ...
    for i in range(0,nMAX_ROBOTS):
     ...
     xy = int(112/float(1760)*aBoes[i].nY) + 0027 #del borde rojo
