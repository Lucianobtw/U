...
if (validar($nombre, $apellido, $email, $asunto) == true) {
    ...
    $sql = "INSERT INTO `contacto`(`Primer_Nombre`, `Primer_Apellido`, `email`, `Asunto`) VALUES ('$nombre','$apellido','$email','$asunto')";
    ...
    if ($result) {
        $response['success'] = "Se ha enviado la solicitud correctamente";
